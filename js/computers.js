...
function addComputersToTable(computersArray){
    ...
    for (let index = 0; index < computersArray.length; index++) {
        ...
        computerstbodyHtml+="<td><button class='delete-button' onclick='onDelete("+c.id+")' >Sil</button>";
        computerstbodyHtml+="<button class='edit-button'  onclick='onEdit("+c.id+")'>Redakte</button></td>";
        computerstbodyHtml+="</tr>";
    }
